...
<html>
    <head>
        ...
        <script src="scripts/log_script.js"></script>
        <link rel="stylesheet" href="css/login_style.css">
        <script src="https://apis.google.com/js/platform.js" async defer></script>
        <meta name="google-signin-client_id" content="702701829361-fnbmf2buer7fidl1u6qvsb7ur6cuks9n.apps.googleusercontent.com">
    </head>
    <body>
        <div class="card-container mdl-card mdl-shadow--2dp">
            ...
            <div class="mdl-card__supporting-text">
                <form id="new-student-form" method="post" action="?action=login_d">
                    ...
                    <div class="mdl-card__actions">
                       ...
                       <!--   <a href="?action=auth">Log in with Google</a> -->
